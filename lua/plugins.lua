...
return require('packer').startup(
    ...
    function(use)
        ...
        use { 'tom-anders/telescope-vim-bookmarks.nvim', requires = 'MattesGroeger/vim-bookmarks', config = require('plugins._bookmarks').config, setup = require('plugins._bookmarks').setup }
        ...
        use { 'nvim-telescope/telescope-live-grep-args.nvim', requires = 'nvim-telescope/telescope.nvim', config = require('plugins._telescope_rg').config }
